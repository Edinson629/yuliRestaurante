    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nombre" id="nombre" aria-describedby="helpId" placeholder="Nombre comida" />
            ...
            <button type="submit" class="btn btn-success"><strong>Agregar comida</strong></button>
