                ...
                <tbody>
                    <?php foreach ($lista_menu as $registro) { ?>
                        <tr class="">
                            ...
                            <td>
                                <img src="../../../images/menu/<?php echo ($registro['foto']); ?>" width="100" alt="" srcset="">
                            </td>
                            <td><?php echo $registro['precio']; ?></td>
                            <td>
                                <a name="" id="" class="btn btn-info" href="editar.php?txtID=<?php echo ($registro['ID']); ?>" role="button"><strong> Editar</strong></a>
                                <br><br>
                                <a name="" id="" class="btn btn-danger" href="index.php?txtID=<?php echo ($registro['ID']); ?>" role="button"><strong> Borrar</strong></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
