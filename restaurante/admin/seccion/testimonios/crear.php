    ...
    <div class="card-body">
        <form action="" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="opinion" id="opinion" aria-describedby="helpId" placeholder="Opinión" />
            </div>
            ...
            <button type="submit" class="btn btn-success"><strong>Agregar testimonio</strong></button>
